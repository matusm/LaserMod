...
namespace LaserMod
{
    public class ParameterContainer
    {
        ...
        public double Mpp1LSQ => TotalizeToHz(movFitter.ModulationDepth1LSQ) * SincCorrection1 + InstrumentConstants.MppLsqCorrection;
        public double Mpp1DispLSQ => TotalizeToHz(movFitter.ModulationDepth1DispersionLSQ);
        public double Mpp2LSQ => TotalizeToHz(movFitter.ModulationDepth2LSQ) * SincCorrection2 + InstrumentConstants.MppLsqCorrection;
